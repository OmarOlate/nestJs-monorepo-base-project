...
import {
  ...
  TemporaryPassword,
  User,
} from 'libs/auth/database';
import { SendOneMailModule } from '@nest-js-monorepo-base-project/send-one-mail';
...
@Module({
  ...
  exports: [DeactivateUserForPasswordUseCase],
  imports: [
    TypeOrmModule.forFeature([User, TemporaryPassword, StatusUser]),
    AuthDatabaseModule,
    SendOneMailModule,
  ],
})
